...
-   HW01 scores posted; Scores on Canvas; feedback as "issue" on GH
...
::: callout-note
While I drop duplicatess *after* making the plots above, you and your group will want to think about when it should be done for telling the clearest story. The order we do things in EDA is not typically the order in which we communicate information.
:::
