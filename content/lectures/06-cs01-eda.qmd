...
::: callout-warning
This is beyond code I would expect you all to be able to write yourself. It's here so that 1) you can make these calculations and interpret the results, and 2) because we have a wide range of background and experience. I want *everyone* to get as much as they can out of this course.
:::
...
- There are other compounds and other cutoffs to consdier
:::
