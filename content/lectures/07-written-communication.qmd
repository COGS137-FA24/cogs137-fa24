...
- `r emo::ji("science")` **Lab 03** due tonight (11:59 PM)
- `r emo::ji("computer")` **HW02** (Viz) due Mon (10/28; 11:59 PM)
- `r emo::ji('clipboard')` Lecture Participation survey "due" after class

Notes: 
- error in lab03 data; needs `mutate(Group = fct_recode(Group, "Frequent user" = "Experienced user", "Occasional user" = "Not experienced user"))`
- The Freakonomics podcast is currently in the middle of a 3-part series on the economics of cannabis
